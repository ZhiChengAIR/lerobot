...
def get_from_raw_to_lerobot_format_fn(raw_format: str):
    ...
    elif raw_format == "zcai_pusht_zarr":
    ...
    elif raw_format == "zcai_aloha2_resize":
        from lerobot.common.datasets.push_dataset_to_hub.zcai_aloha2_resize_format import (
            from_raw_to_lerobot_format,
        )
    ...
    elif raw_format == "zcai_tr3":
        from lerobot.common.datasets.push_dataset_to_hub.zcai_tr3_format import (
            from_raw_to_lerobot_format,
        )
    elif raw_format == "zcai_tr4":
        from lerobot.common.datasets.push_dataset_to_hub.zcai_tr4_format import (
            from_raw_to_lerobot_format,
        )
    else:
        raise ValueError(
